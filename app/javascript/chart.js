    ...
    try {
        ...
        function restartSocket() {
            ...
            socket = new WebSocket(
                `wss://stream.binance.com:9443/ws/${symbol.toLowerCase()}usdt@kline_${currentInterval}`
            );
